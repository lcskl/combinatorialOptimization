...
{
   // Unfortunately the common std input functions force us to first declare
   // our variables and then assign the correct values to them later.
...
std::vector<MMC::NodeId> Graph::odd_v_minus() const{
   MMC::NodeId node_id = 0;
   unsigned int neg_edges = 0;
   std::vector<MMC::NodeId> odd_deg_negative;
